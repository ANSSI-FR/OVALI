...
Vizu.colors = {
  ...
  foreignobject: {background: "#ffffff", border: "#a352cc", highlight: {background: "#ffffff", border: "#a352cc"}},
  ...
  uforeignobject: {background: "#f3f3f3", border: "#d8c0e4", highlight: {background: "#ffffff", border: "#a352cc"}},
...
Vizu.options.network = {
  groups: {
    ...
    foreignobject: {label: "?", color: Vizu.colors.foreignobject},
